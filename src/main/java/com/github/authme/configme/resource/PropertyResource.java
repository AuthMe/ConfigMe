...
public interface PropertyResource {
     ...
     * New values are only persisted after {@link #exportProperties(PropertyMap)} has been called.
     *
     ...
     *
     * @param propertyMap the property map for all properties to consider
     */
